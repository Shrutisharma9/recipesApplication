...
@Api(value = "IngredientController", tags = "Ingredient Controller", description = "Create, update, delete and list ingredients")
@RestController
...
public class IngredientController {
    ...
    public List<IngredientResponse> getIngredientList(@PathVariable(name = "page") int page,
        ...
        List<IngredientEntity> list = ingredientService.list(page, size);
